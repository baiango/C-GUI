...
foreign lib {
	...
	SetWindowState           :: proc(flags: ConfigFlag) ---                    // Set window configuration state using flags (only PLATFORM_DESKTOP)
	ClearWindowState         :: proc(flags: ConfigFlag) ---                    // Clear window configuration state flags
	...
	SetConfigFlags :: proc(flags: ConfigFlag) ---       // Setup init configuration flags (view FLAGS)
